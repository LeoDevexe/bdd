...
insert into estudiantes (cedula,nombre,apellido,email,fecha_nacimiento)
values (1235476811,'Anabel','Perlaza','WPerlaza18@gmail.com','12/04/2000');
insert into estudiantes (cedula,nombre,apellido,email,fecha_nacimiento)
...
insert into transacciones(codigo, numero_cuenta, monto, tipo, fecha, hora)
values(23210, '32015', 400, 'C', '03/02/2008', '13:55');
...
insert into videojuegos(codigo, nombre, descripcion, valoracion)
values(93475, 'Call of Clans', 'juego de terror', 3);

insert into videojuegos(codigo, nombre, descripcion, valoracion)
values(15983, 'Fornite', 'juego de suspenso', 4);

insert into videojuegos(codigo, nombre, descripcion, valoracion)
values(35784, 'Minecraft', 'juego de drama', 3);
